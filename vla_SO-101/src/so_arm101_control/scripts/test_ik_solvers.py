...
# Orientation (0,0.707,0,0.707) = pitched 90 deg forward
TEST_POSES = [
    # Reachable positions near home config
    ...
    # Poses with non-identity orientation (harder for 5-DOF)
    (0.12, 0.0, 0.15, 0.0, 0.707, 0.0, 0.707, 'pitched_forward'),
    (0.10, 0.0, 0.10, 0.383, 0.0, 0.0, 0.924, 'rolled_45'),
    # Edge-of-workspace poses
    (0.20, 0.0, 0.10, 0.0, 0.0, 0.0, 1.0, 'far_front'),
    (0.05, 0.10, 0.10, 0.0, 0.0, 0.0, 1.0, 'far_right'),
    (0.0, 0.0, 0.25, 0.0, 0.0, 0.0, 1.0, 'straight_up'),
]
